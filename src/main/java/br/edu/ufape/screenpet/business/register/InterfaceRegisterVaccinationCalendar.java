...
public interface InterfaceRegisterVaccinationCalendar {
	...
	VaccinationCalendar saveVaccinationCalendar(VaccinationCalendar entity) throws VaccinationCalendarDuplicateException, VaccinationCalendareNotExistsException;
